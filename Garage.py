...
def init_google_cloud_clients(key_path):
    ...
    # google-cloud-* clients pick credentials up automatically from this env var.
...
def signup():
    try:
        ...
        # NOTE: the password is intentionally NOT stored here. Firebase Auth
        # already stores it securely (hashed); duplicating it in Firestore in
        # plaintext would be a serious security liability.
        seller_data = {
